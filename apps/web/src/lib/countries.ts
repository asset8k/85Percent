/**
 * ISO 3166-1 alpha-2 country list used by the nationality picker.
 *
 * Only the canonical English short name + alpha-2 code is stored. The flag
 * emoji is derived at render time by mapping each letter to its Unicode
 * regional indicator symbol (U+1F1E6 + offset). Codes are uppercase.
 */
export interface Country {
  code: string  // ISO 3166-1 alpha-2 (e.g. "GB", "BR")
  name: string  // English short name (e.g. "United Kingdom")
}
