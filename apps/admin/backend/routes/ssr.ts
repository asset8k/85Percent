...
import type { ApiApp, ApiRequest, ApiReply } from '../serverless/types'
import { z } from 'zod'
...
async function ensurePremierLeague(request: ApiRequest, reply: ApiReply): Promise<boolean> {
...
// Routes
// ---------------------------------------------------------------------------
export async function ssrRoutes(app: ApiApp) {
