...
import type { ChatMessage, ChatFinishResult } from '../services/ai/index'
import { calculateQueryCost } from '../utils/aiPricing'
...
export async function chatRoutes(app: ApiApp) {
