 ...
 * 3 submissions per hour per IP is strict on purpose: a real club fills the
 * form once; anything past 3/hr from one address is abuse.
 *
...
/** Returns `{ success: false }` when this IP has exceeded 3 submissions in the
